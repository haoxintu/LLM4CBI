...
rq1_2_diwi <- read_xls("./tse-llm4cbi/rq1-2-diwi.xls")
print("############ data from table rq1_diwi ###########")
print(rq1_2_diwi)

rq1_2_recbi <- read_xls("./tse-llm4cbi/rq1-2-recbi.xls")
print("############ data from table rq1_diwi ###########")
print(rq1_2_recbi)

rq1_2_llm4cbi <- read_xls("./tse-llm4cbi/rq1-2-llm4cbi.xls")
print("############ data from table rq1_llm4cbi ###########")
print(rq1_1_llm4cbi)


tem_table <- rq1_2_recbi
tem_llm4cbi <- rq1_2_llm4cbi
## TOP-1
